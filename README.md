# coleap
"This is an is a sample project for coleap

![Screenshot](src//assets/images/Home-page.png)
![Screenshot](src/assets/images/deatil-page.png)
...
- JSX, Tailwindp, JavaScript, React, react-router-dom, react-redux;
...
```sh
git@github.com:fortuneonyeka/coleap.git
```
